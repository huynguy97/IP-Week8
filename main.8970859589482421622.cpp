...
*/
    ...
    TrackDisplay disp;
    disp.showTitle = true;
    disp.showCountry = true;
    disp.showLength = true;
    disp.showTags = true;
    disp.showYear = true;
    disp.showAlbum = true;
    disp.showArtist = true;
    disp.showTrack = true;
...
*/
    ...
    string b;
    TrackDisplay disp;
    disp.showTitle = false;
    disp.showCountry = false;
    disp.showLength = false;
    disp.showTags = false;
    disp.showYear = false;
    disp.showAlbum = false;
    disp.showArtist = true;
    disp.showTrack = false;
    while (i < tracks.size())
    {
        ...
        a = tracks [i].artist;
        b = tracks [i].artist;
        while (a == b && i != tracks.size() - 1)
        {
            i++;
            b = tracks [i].artist;
        }
        if(i == tracks.size() - 1 && a == b)
            i++;
    }
    return n_of_artists;
}
...
ostream& operator<< (ostream& out, Track& tracks)
{//              
    assert (true) ;
/*                
...
void reading_file (Track& tracks)
{//              
    assert (true) ;
/*                
