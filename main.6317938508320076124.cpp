...
{//              
  ...
  //                                                                                                                                                                                                                           
  //                                                                                                                                                          
  int n=0; string title;
  TrackDisplay disp = {true,true,true,true,true,true,true,true};
...
{//              
 ...
 //                                                                                                                                                           
  ...
  int n=0; string artistName;
  TrackDisplay disp = {true,false,false,false,false,false,false,false};

    for(int i=0;i<tracks.size();i++)
    {
        artistName=tracks[i].artist;
        if(match(artist,artistName) && tracks[i].artist!=tracks[i+1].artist)
        {
            n++;
            if(display)
            show_track(tracks[i],disp);
...
{//              
    ...
    //                                                                                                                                                             
    int n=0; string artistName;
    TrackDisplay disp = {true,true,true,false,false,false,false,false};

    for(int i=0;i<tracks.size();i++)
    {
        artistName=tracks[i].artist;
        if(match(artist,artistName) && tracks[i].cd!=tracks[i+1].cd)
        {
            n++;
            if(display)
            show_track(tracks[i],disp);
...
{//              
    ...
    Track entry;
    TrackDisplay disp = {false,false,false,true,false,false,false,false};
    ...
    DB.push_back(entry);
    counter++;
    show_track(entry,disp);
    cout<<endl;
    }

    cout<<"There are "<<counter-1<<" entries.";
