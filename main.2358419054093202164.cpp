...
*/
    ...
    sum.seconds = total_seconds % 60; //                                           
    sum.minutes = a.minutes + b.minutes + (total_seconds - sum.seconds)/60; //                                                                              
    return sum;
}
...
*/
    ...
    for(int i = 1;i<=8;i++) //                             
    {
        ...
        else
        {
            ...
            switch(i) //                                                         
            {
                case 1: track.artist = input; break;
                case 2: track.cd = input; break;
                case 3: track.year = atoi(input); break; //                             
                case 4: track.track = atoi(input); break;
                case 5: track.title = input; break;
                case 6: track.tags = input; break;
                case 8: track.country = input; break;
            }
...
bool contains_string(vector<string>& string_array, string element)
{
    //              
    assert (true) ;
/*                
...
*/
    bool found = false;
    for(int i=0; i < static_cast<int>(string_array.size()); i++) //                                                                                    
    {
        if(string_array[i] == element)
            found = true;
    }
    return found;
}
...
*/
    int matches = 0;
    vector<string> artist_array;

    for(int i=0; i < static_cast<int>(tracks.size()); i++)
    {
        if(match(artist,tracks[i].artist) && !contains_string(artist_array,tracks[i].artist)) //                                                        
        {
            matches++;
            artist_array.push_back(tracks[i].artist); //                                                    
            if(display)
...
*/
    int matches = 0;
    vector<string> cd_array;

    for(int i=0; i < static_cast<int>(tracks.size()); i++)
    {
        if(match(artist,tracks[i].artist) && !contains_string(cd_array,tracks[i].cd)) //                                                    
        {
            matches++;
            cd_array.push_back(tracks[i].cd);
            if(display)
...
*/
    ...
    for(int i=0; i < static_cast<int>(tracks.size()); i++)
    {
        if(!contains_string(cd_array,tracks[i].cd)) //                                                        
        {
            amount++;
            cd_array.push_back(tracks[i].cd);
        }
...
*/
    ...
    cout << "Amount of CD tracks: " << i << endl;
