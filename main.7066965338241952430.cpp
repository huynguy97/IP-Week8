...
//                                                                                                                                                      
    int counter = 0;
    TrackDisplay a =  {true, true, true, true, true, true, true, true};
...
//                                                                                                                                  
    ...
    TrackDisplay a =  {true, false, false, false, false, false, false, false};
    for(int i=0 ;i < static_cast<int>(tracks.size()); i++)
    {
        if(match(artist, tracks[i].artist))
        {
            if(previous_artist != tracks[i].artist)
            {
                previous_artist = tracks[i].artist ;
                counter++;
                if(display)
                show_track(tracks[i], a);
            }
...
//                                                                                                                                                                                   
    ...
    TrackDisplay a =  {true, true, true, false, false, false, false, false};
    for(int i=0 ;i < static_cast<int>(tracks.size()); i++)
    {
        if(match(artist, tracks[i].artist))
        {
            if(previous_album != tracks[i].cd)
            {
                previous_album = tracks[i].cd ;
                counter++;
                if(display)
                show_track(tracks[i], a);
            }
...
void read_file (ifstream& in, Track& track, vector<Track>& tracks)
{
//               
assert (true) ;
//              
...
read_file(in, track, tracks);
cout << "the number of entries is " << static_cast<int>(tracks.size()-1) << endl << endl ;
cout << "************************************************************************************************************" << endl << endl;
cout << "there are " << match_tracks(tracks, "el", true) << " tracks that contain the string el." << endl << endl;
cout << "************************************************************************************************************" << endl << endl;
cout << "there are " << match_artist(tracks, "el", true) << " artists that contain the string el" << endl << endl;
cout << "************************************************************************************************************" << endl << endl;
cout << "there are " << match_cds(tracks, "el", true) << " albums by artists with name containing the string el " << endl << endl;
cout << "************************************************************************************************************" << endl << endl;
cout << "there are " << number_of_cds(tracks) << " albums" << endl;
return 0;
}
