...
*/
    ...
    if (display)
    {
        cout << "The number of matching tracks is " << counter << endl ;
    }
    return counter ;
}
...
*/
    ...
    for (int i = 0 ; i < tracks.size() ; i ++)
    {
        if (match(artist, tracks[i].artist) && tracks[i-1].artist != tracks[i].artist)
        {
            counter ++ ;
            if (display)
            {
    ...
    if (display)
    {
        cout << "The number of matching artists is " << counter << endl ;
    }
    return counter ;
}
...
*/
    ...
    for (int i = 0 ; i < tracks.size() ; i ++)
    {
        ...
        {
            for (int j = 0 ; j < cd_names.size() ; j ++)
            {
                if (cd_names[j] == tracks[i].cd)
                {
                    same_name ++ ;
                }
            }
            if (same_name == 0)
            {
                cd_names.push_back(tracks[i].cd) ;
                counter ++ ;
            }
            if (display && same_name == 0)
            {
                show_track(tracks[i], td) ;
            }
        }
    ...
    if (display)
    {
        cout << "The number of CDs of the entered artist is " << counter << endl ;
    }
    return counter ;
}
