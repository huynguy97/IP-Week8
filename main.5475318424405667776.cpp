...
const TrackDisplay showartist= {true, false, false, false,false,false,false,false};
const TrackDisplay showcds= {true, true, true, false, false, false, false, false};
/*                                                                                 
...
vector<Track> testDB = {
    ...
    ,{"Colin Svector<Track>& tracks, string artist, bool display)tetson and Sarah Neufeld","Never were the way she was",  2015,7, "Never were the way she was",  "jazz,instrumental,experimental",    { 8,12},"U.S.A.,Canada"}
...
{//             
   ...
   //                                                                                                         
    ...
    for(int i=0; i<tracks.size(); i++)
    {
        ...
        {
            if(display) {
               show_track(tracks[i], showartist);
            }
             match_artist++;
        }
    }
...
{//             
   ...
   //                                                                                                                                        
    ...
    for(int i=0; i<tracks.size(); i++)
    {
        if(match(artist,tracks[i].title))
            if(display)
        {
            show_track(tracks[i], showcds);
        }
    }match_cds++;
    return match_cds;
}
