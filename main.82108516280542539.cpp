...
int main()
{
    ...
    */
    ...
    while (inputfile)
    {
        ...
        if(inputfile){
            inputfile >> t;
            allthesongs.push_back(t);
        }
    }
    cout << match_tracks(allthesongs, "ve", true ) << endl << endl;
    cout << match_artists(allthesongs, "ve", true) << endl << endl;
    cout << match_cds(allthesongs, "ve", true) << endl << endl;
    cout << number_of_cds(allthesongs);
}
