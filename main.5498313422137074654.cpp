...
*/
    ...
    cout << "the amount of matching tracks: " << counter << endl;
    return counter;
}
...
*/
    ...
    cout << "the amount of matching artists: " << counter2 << endl;
    return counter2;
}
...
*/
    ...
    cout << "the amount of artists with matching cd: " << counter3 << endl;
    return counter3;
}
...
*/
    ...
    cout << "number of cd's: " << counter4 << endl;
    return counter4;
}
...
*/
    ...
    getline (in, track.cd);
    getline (in, value);
    track.year = stoi (value);
    getline (in, value);
    track.track = stoi (value);
