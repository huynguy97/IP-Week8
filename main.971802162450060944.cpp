...
int number_of_tracks(ifstream& infile, Track& track, TrackDisplay& td, vector<Track>& tracks)
{//              
    assert(infile.is_open());
/*                
...
*/
    ...
    open_file(infile);
    vector<Track>tracks;
    TrackDisplay td = {1, 1, 1, 1, 1, 1, 1, 1};
    Track track;
    int a = number_of_tracks(infile, track, td, tracks);
    cout << '\n' << "The number of tracks is: " << a << '\n' << "The artists matching the given string are: " << '\n' << endl;
    int b = match_artists(tracks, "el", true);
    cout << '\n' << "The amount of these artists that match your string is: " << '\n' << b << '\n' << "The tracks of these artists: " << '\n' << endl;
    int c = match_cds(tracks, "el", true);
    cout << '\n' << "The amount of cds that match your string are: " << c << endl;
    int d = number_of_cds(tracks);
    cout << '\n'<< "The total number of cds is: " << d << endl;
    return 0;
}
