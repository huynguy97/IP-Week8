...
*/
    int no_tracks = 0;
    TrackDisplay ts = {true, true, true, true, true, true, true, true};
...
*/
    int no_artists = 0;
    TrackDisplay ts = {true, false, false, false, false, false, false, false};
    set<string> unique_artists;

    for (int i = 0; i < tracks.size(); i++) {
        if (match(artist, tracks[i].artist)) {
            if (unique_artists.find(tracks[i].artist) == unique_artists.end()) {
                unique_artists.insert(tracks[i].artist);
...
*/
    int no_cds = 0;
    TrackDisplay ts = {true, true, true, false, false, false, false, false};
    set<string> unique_cds;

    for (int i = 0; i < tracks.size(); i++) {
        if (match(artist, tracks[i].artist)) {
            if (unique_cds.find(tracks[i].cd) == unique_cds.end()) {
                unique_cds.insert(tracks[i].cd);
...
*/
    ...
    cout << match_artists(testDB, "el", true) << endl
         << "==============================" << endl;
    cout << match_cds(testDB, "el", true) << endl
         << "==============================" << endl;
    cout << "Total number of CDs in database: "
         << number_of_cds(testDB) << endl
         << "==============================" << endl;
    ...
    int entries = db.size();
    cout << "Reading successful, number of entries read: " << entries << '\n';
