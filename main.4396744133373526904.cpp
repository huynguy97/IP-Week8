...
istream& operator>> (istream& in, Length& length)
{
    ...
    */
    ...
    while (double_dot != ':')
    {
        cout << "That is not a valid time stamp. Please enter minutes:seconds. " << endl;
        in  >> length.minutes
            >> double_dot
            >> length.seconds;
    }
...
void show_track (Track track, TrackDisplay lt)
{
    ...
    */
    ...
    if (!lt.showArtist && !lt.showAlbum && !lt.showYear && !lt.showTrack && !lt.showTitle && !lt.showTags && !lt.showLength && !lt.showCountry)
...
//                                                                                          
    ...
    cout << "The total number of CDs is: " << k << endl << endl;
}
...
int main()
{
    ...
    */
    ...
    cout << " What file you want to use?" << endl;
    cin >> filename;
    infile.open(filename);

    if(infile)
        cout << "The file has succesfully opened." << endl;
    vector<Track>track;
//                          

    show_track (, true, true, true, true, true, true, true, true);

    string sub1, sub2, sub3;
    cout << "Please enter a search term to search for titles. " << endl;
    cin >> sub1;
    match_tracks(track, sub1, true);
    cout << "Please enter a search term to search for Artists. " << endl;
    cin >> sub2;
    match_artists(track,sub2,true);
    cout << "Please enter a search term to find CDs by searching for an Artist. " << endl;
    cin >> sub3;
    match_cds (track,sub3,true);
