...
bool Appeared(vector<string>& namen, string naam)
{
...
vector<string> artiesten;
    for (int i = 0; i< tracks.size()-1;i++)
    {
        if (match(artist, tracks[i].artist))
        {
            if(Appeared(artiesten, tracks[i].artist))
            {
            ;
            }
            else
            {
            j++ ;
            artiesten.push_back(tracks[i].artist) ;
                if(display)
                {
                    show_track(tracks[i],lt);
                }
...
vector<string> albums;
    for (int i = 0; i< tracks.size()-1;i++)
    {
        if (match(artist, tracks[i].artist))
        {
            if(Appeared(albums, tracks[i].cd))
            {
            ;
            }
            else
