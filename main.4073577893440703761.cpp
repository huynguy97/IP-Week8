...
bool isIn(vector<string> source, string sub)
{//              
    assert(true);
//                                                                       
...
//                                                     
    ...
    for(int i = 0; i < tracks.size(); i++){
        if(match(artist, tracks[i].artist)){
            if(!isIn(artists, tracks[i].artist)){
                num++;
...
int read_file(vector<Track>& tracks)
{//              
    assert(true);
//                                                           
