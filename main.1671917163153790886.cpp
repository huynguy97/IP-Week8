 ...
 */
    cout << "All matching tracks for the term are:" << endl;
 ...
 */
    cout << "All matching artists for the term are:" << endl;
    TrackDisplay artists = {true, false, false, false, false, false, false, false};
    int counter = 0;
    string prev;
    string next;
    ...
    for (int i = 0; i < tracks.size(); i++)
    {
        next = tracks.at(i).artist;
        if (match(artist, tracks.at(i).artist) && !match(next, prev))
        {
            counter++;
            if (display)
                show_track(tracks[i], artists);
        }
        prev = next;
    }
    return counter;
 ...
 */
    cout << "All matching cds for the term are:" << endl;
    TrackDisplay cd = {true, true, true, false, false, false, false, false};
    int counter = 0;
    string prev;
    string next;
    for (int i = 0; i < tracks.size(); i++)
 ...
 */
    cout << "The total amount of cds is:" << endl;
    int counter = 0;
    string prev;
    string next;
    for (int i = 0; i < tracks.size(); i++)
...
*/
    ...
    string input;
    cin >> input;
    match_tracks(testDB, input, true);
    match_artists(testDB, input, true);
    match_cds(testDB, input, true);
